...
p<-ggplot(port_EDA[port_EDA$goout<=5,], aes(x=G_average, y=goout)) +
...
p<-ggplot(port_EDA[port_EDA$Dalc<=5,], aes(x=G_average, y=Dalc)) +
...
p<-ggplot(port_EDA[port_EDA$Walc<=5,], aes(x=G_average, y=Walc)) +
...
p<-ggplot(port_EDA[port_EDA$health<=5,], aes(x=G_average, y=health)) +
...
p<-ggplot(port_EDA[port_EDA$traveltime<=5,], aes(x=G_average, y=traveltime)) +
...
p<-ggplot(port_EDA[port_EDA$studytime<=5,], aes(x=G_average, y=studytime)) +
...
p<-ggplot(port_EDA[port_EDA$failures<=5,], aes(x=G_average, y=failures)) +
